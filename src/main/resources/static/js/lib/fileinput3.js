...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tPreview = '<div class="file-preview {class}">\n' +
            ...
            '    <div class="{dropClass}" style="width: 385px;margin-bottom:5px;">\n' +
        ...
        tFooter = '<div class="file-thumbnail-footer">\n' +
            ...
            '<div><input id="cuttoolpicname" name="name" type="hidden" value="{caption}">{caption}</div>\n' +
            '</div>\n' +
            '    {actions}\n' +
            '</div>',
        ...
        defaultPreviewSettings = {
            image: {width: window.screen.width / 7 + "px", height: window.screen.height / 4.5 + "px"},
