...
!function (e) {
    ...
    var i, t, a, r, n, l, o, s, d, c, p, u, f, v, g, m, h, w, b, C, x, y, T, F, E, I, $, k, P, S, D, U, A, j, L, z, O, R, M, N, B, Z, H, W, q, _, V, K, X, J, Q, Y, G, ee;
    i = ".fileinput", t = window.URL || window.webkitURL, a = function (e, i, t) {
        ...
        data: {}, init: function (e) {
            ...
            i.length > 0 && !K(i) && (i = i.split(e.initialPreviewDelimiter)), o.data[t] = {
                content: i,
            ...
            return a = void 0 === a ? !0 : a, null === s.content[t] ? "" : (V(d) || V(d.frameClass) || (p += " " + d.frameClass), r = s.template.replace(/\{previewId}/g, c).replace(/\{frameClass}/g, p).replace(/\{fileindex}/g, l).replace(/\{content}/g, s.content[t]).replace(/\{footer}/g, o.footer(i, t, a)), s.tags.length && s.tags[t] && (r = G(r, s.tags[t])), V(d) || V(d.frameAttr) || (n = e(document.createElement("div")).html(r), n.find(".file-preview-initial").attr(d.frameAttr), r = n.html(), n.remove()), r)
        }, add: function (i, t, a, r, n) {
            var l, s = e.extend(!0, {}, o.data[i]);
            return K(t) || (t = t.split(s.delimiter)), n ? (l = s.content.push(t) - 1, s.config[l] = a, s.tags[l] = r) : (l = t.length, s.content = t, s.config = a, s.tags = r), o.data[i] = s, l
        }, set: function (i, t, a, r, n) {
            var l, s, d = e.extend(!0, {}, o.data[i]);
            if (t && t.length && (K(t) || (t = t.split(d.delimiter)), s = t.filter(function (e) {
                    return null !== e
                }), s.length)) {
            ...
            var a = o.data[e];
            if (t = void 0 === t ? !0 : t, 0 === a.config.length || V(a.config[i]))return "";
            var r = a.config[i], n = X("caption", r) ? r.caption : "", l = X("width", r) ? r.width : "auto", s = X("url", r) ? r.url : !1, d = X("key", r) ? r.key : null, c = s === !1 && t, p = a.isDelete ? a.actions(!1, !0, c, s, d) : "", u = a.footer.replace(/\{actions}/g, p);
        ...
        object: N,
        other: B
    }, W = ["image", "html", "text", "video", "audio", "flash", "object"], q = {
        ...
        var a = this;
        a.$element = e(i), a.validate() && (a.isPreviewable = d(), a.isIE9 = r(9), a.isIE10 = r(10), a.isPreviewable || a.isIE9 ? (a.init(t), a.listen()) : a.$element.removeClass("file-loading"))
    }, ee.prototype = {
        constructor: ee, validate: function () {
            var e, i = this;
            ...
            var i = this, t = X(e, i.layoutTemplates) ? i.layoutTemplates[e] : Z[e];
            return V(i.customLayoutTags) ? t : G(t, i.customLayoutTags)
        }, getPreviewTemplate: function (e) {
            var i = this, t = X(e, i.previewTemplates) ? i.previewTemplates[e] : H[e];
            return V(i.customPreviewTags) ? t : G(t, i.customPreviewTags)
            ...
            l(t, "change", e.proxy(i.change, i)), l(i.$btnFile, "click", e.proxy(i.browse, i)), l(a, "reset", e.proxy(i.reset, i)), l(r.find(".fileinput-remove:not([disabled])"), "click", e.proxy(i.clear, i)), l(r.find(".fileinput-cancel"), "click", e.proxy(i.cancel, i)), i.initDragDrop(), i.isUploadable || l(a, "submit", e.proxy(i.submitForm, i)), l(i.$container.find(".fileinput-upload"), "click", e.proxy(i.uploadClick, i))
        }, zoneDragDropInit: function (e) {
            e.stopPropagation(), e.preventDefault()
        }, zoneDragEnter: function (i) {
            var t = this, a = e.inArray("Files", i.originalEvent.dataTransfer.types) > -1;
            return t.zoneDragDropInit(i), t.isDisabled || !a ? (i.originalEvent.dataTransfer.effectAllowed = "none", void(i.originalEvent.dataTransfer.dropEffect = "none")) : void u(t.$dropZone, "file-highlighted")
        }, zoneDragLeave: function (e) {
            var i = this;
            i.zoneDragDropInit(e), i.isDisabled || i.$dropZone.removeClass("file-highlighted")
        }, zoneDrop: function (e) {
            var i = this;
            e.preventDefault(), i.isDisabled || V(e.originalEvent.dataTransfer.files) || (i.change(e, "dragdrop"), i.$dropZone.removeClass("file-highlighted"))
        }, initDragDrop: function () {
            var i = this, t = i.$dropZone;
            i.isUploadable && i.dropZoneEnabled && i.showPreview && (l(t, "dragenter dragover", e.proxy(i.zoneDragEnter, i)), l(t, "dragleave", e.proxy(i.zoneDragLeave, i)), l(t, "drop", e.proxy(i.zoneDrop, i)), l(e(document), "dragenter dragover drop", i.zoneDragDropInit))
        }, browse: function (e) {
            var i = this;
            i.raise("filebrowse"), e && e.isDefaultPrevented() || (i.isError && !i.isUploadable && i.clear(), i.$captionContainer.focus())
        }, uploadClick: function (e) {
            var i, t = this, a = t.$container.find(".fileinput-upload"), r = !a.hasClass("disabled") && V(a.attr("disabled"));
            ...
            var t, a = this;
            return a.ajaxAborted && "object" == typeof a.ajaxAborted && void 0 !== a.ajaxAborted.message ? (t = e.extend(!0, {}, a.getOutData(), i), t.abortData = a.ajaxAborted.data || {}, t.abortMessage = a.ajaxAborted.message, a.cancel(), a.setProgress(100, a.$progress, a.msgCancelled), a.showUploadError(a.ajaxAborted.message, t, "filecustomerror"), !0) : !1
        }, setProgressCancelled: function () {
            var e = this;
            e.setProgress(100, e.$progress, e.msgCancelled)
        }, setProgress: function (e, i, t) {
            var a = this, r = Math.min(e, 100), n = 100 > r ? a.progressTemplate : t ? a.progressErrorTemplate : a.progressCompleteTemplate;
            i = i || a.$progress, V(n) || (i.html(n.replace(/\{percent}/g, r)), t && i.find('[role="progressbar"]').html(t))
        }, lock: function () {
            var e = this;
            e.resetErrors(), e.disable(), e.showRemove && u(e.$container.find(".fileinput-remove"), "hide"), e.showCancel && e.$container.find(".fileinput-cancel").removeClass("hide"), e.raise("filelock", [e.filestack, e.getExtraData()])
        }, unlock: function (e) {
            var i = this;
            void 0 === e && (e = !0), i.enable(), i.showCancel && u(i.$container.find(".fileinput-cancel"), "hide"), i.showRemove && i.$container.find(".fileinput-remove").removeClass("hide"), e && i.resetFileStack(), i.raise("fileunlock", [i.filestack, i.getExtraData()])
            ...
            i.getThumbs().each(function () {
                ...
                -1 !== l && (void 0 !== o ? (a[t] = o, r[t] = i.getFileName(o), n.attr({
                    ...
                    "data-fileindex": t
                }), t++) : n.attr({id: "uploaded-" + Q(), "data-fileindex": "-1"}))
            }), i.filestack = a, i.filenames = r
        }, destroy: function () {
            var e = this, t = e.$container;
            t.find(".file-drop-zone").off(), e.$element.insertBefore(t).off(i).removeData(), t.off().remove()
        }, refresh: function (i) {
            var t = this, a = t.$element;
            i = i ? e.extend(!0, {}, t.options, i) : t.options, t.destroy(), a.fileinput(i), a.val() && a.trigger("change.fileinput")
            ...
            return o.count(t.id) ? (i = o.out(t.id), a = e && t.initialCaption ? t.initialCaption : i.caption, t.$preview.html(i.content), t.setCaption(a), void(V(i.content) || t.$container.removeClass("file-input-new"))) : (t.clearPreview(), void(e ? t.setCaption(a) : t.initCaption()))
            ...
            i.$preview.find(".kv-file-remove").each(function () {
                ...
                if (!V(n) && void 0 !== s) {
                    ...
                    m = parseInt(m.replace("init_", "")), p = V(g.config) && V(g.config[m]) ? null : g.config[m], f = V(p) || V(p.extra) ? t : p.extra, "function" == typeof f && (f = f()), c = {
                        id: r.attr("id"),
                        key: s,
                        extra: f
                    }, d = e.extend(!0, {}, {
                        ...
                        type: "POST",
                        dataType: "json",
                        data: e.extend(!0, {}, {key: s}, f),
                        beforeSend: function (e) {
                            i.ajaxAborted = !1, i.raise("filepredelete", [s, e, f]), i.ajaxAborted ? e.abort() : (u(v, "file-uploading"), u(r, "disabled"))
                        },
                        success: function (e, t, n) {
                            var l, d;
                            return V(e) || V(e.error) ? (o.unset(i.id, m), l = o.count(i.id), d = l > 0 ? i.getMsgSelected(l) : "", i.raise("filedeleted", [s, n, f]), i.setCaption(d), v.removeClass("file-uploading").addClass("file-deleted"), void v.fadeOut("slow", function () {
                                i.clearObjects(v), v.remove(), a(), l || 0 !== i.getFileStack().length || (i.setCaption(""), i.reset())
                            })) : (c.jqXHR = n, c.response = e, i.showError(e.error, c, "filedeleteerror"), v.removeClass("file-uploading"), r.removeClass("disabled"), void a())
                        },
                        error: function (e, t, r) {
                            var n = i.parseError(e, r);
                            c.jqXHR = e, c.response = {}, i.showError(n, c, "filedeleteerror"), v.removeClass("file-uploading"), a()
                        }
                    }, i.ajaxDeleteSettings), l(r, "click", function () {
                        return i.validateMinCount() ? void e.ajax(d) : !1
                    })
                }
            })
            ...
            V(n.val()) || (r.isIE9 || r.isIE10 ? (i = n.closest("form"), t = e(document.createElement("form")), a = e(document.createElement("div")), n.before(a), i.length ? i.after(t) : a.after(t), t.append(n).trigger("reset"), a.before(n).remove(), t.remove()) : n.val(""), r.fileInputCleared = !0)
            ...
            e.uploadCache = {
                ...
                tags: [],
                append: !0
            }, e.uploadCount = 0, e.uploadStatus = {}, e.uploadLog = [], e.uploadAsyncCount = 0, e.loadedImages = [], e.totalImagesCount = 0, e.$btnUpload.removeAttr("disabled"), e.setProgress(0), u(e.$progress, "hide"), e.resetErrors(!1), e.ajaxAborted = !1, e.ajaxRequests = [], e.resetCanvas()
            ...
            t.setProgressCancelled(), t.getThumbs().each(function () {
            ...
            var e, i, t = this;
            o.count(t.id) ? (e = o.out(t.id), t.$preview.html(e.content), i = t.initialCaption ? t.initialCaption : e.caption, t.setCaption(i)) : (t.clearPreview(), t.initCaption())
        }, clearDefaultPreview: function () {
            var e = this;
            e.$preview.find(".file-default-preview").remove()
        }, validateDefaultPreview: function () {
            var e = this;
            e.showPreview && !V(e.defaultPreviewContent) && (e.$preview.html('<div class="file-default-preview">' + e.defaultPreviewContent + "</div>"), e.$container.removeClass("file-input-new"))
        }, resetPreviewThumbs: function (e) {
            var i, t = this;
            return e ? (t.clearPreview(), void t.clearStack()) : void(t.hasInitialPreview() ? (i = o.out(t.id), t.$preview.html(i.content), t.setCaption(i.caption), t.initPreviewDeletes()) : t.clearPreview())
        }, reset: function () {
            var e = this;
            e.resetPreview(), e.$container.find(".fileinput-filename").text(""), e.raise("filereset"), u(e.$container, "file-input-new"), (e.$preview.find(".file-preview-frame").length || e.isUploadable && e.dropZoneEnabled) && e.$container.removeClass("file-input-new"), e.setFileDropZoneTitle(), e.clearStack(), e.formdata = {}
        }, disable: function () {
            var e = this;
            ...
            var o, s = this;
            s.raise("filepreajax", [n, l]), s.uploadExtra(n, l), o = e.extend(!0, {}, {
                xhr: function () {
            ...
            f.showPreview && "object" == typeof i && !e.isEmptyObject(i) && void 0 !== i.initialPreview && i.initialPreview.length > 0 && (f.hasInitData = !0, d = i.initialPreview || [], c = i.initialPreviewConfig || [], p = i.initialPreviewThumbTags || [], r = void 0 === i.append || i.append ? !0 : !1, f.overwriteInitial = !1, void 0 !== t ? a ? (u = t.attr("data-fileindex"), f.uploadCache.content[u] = d[0], f.uploadCache.config[u] = c[0], f.uploadCache.tags[u] = p[0], f.uploadCache.append = r) : (l = o.add(f.id, d, c[0], p[0], r), n = o.get(f.id, l, !1), s = e(n).hide(), t.after(s).fadeOut("slow", function () {
                s.fadeIn("slow").css("display:inline-block"), f.initPreviewDeletes(), f.clearFileInput(), t.remove()
            })) : (o.set(f.id, d, c, p, r), f.initPreview(), f.initPreviewDeletes()))
            ...
            var r, n, l, s, d, c, p, f, v, g, m = this, h = m.getFileStack().length, w = new FormData, b = m.previewInitId + "-" + i, C = m.filestack.length > 0 || !e.isEmptyObject(m.uploadExtraData), x = {
                id: b,
                index: i
            };
            m.formdata = w, m.showPreview && (n = e("#" + b + ":not(.file-preview-initial)"), s = n.find(".kv-file-upload"), d = n.find(".kv-file-remove"), e("#" + b).find(".file-thumb-progress").removeClass("hide")), 0 === h || !C || s && s.hasClass("disabled") || m.abort(x) || (g = function (e, i) {
                ...
                m.fileBatchCompleted && setTimeout(function () {
                    m.showPreview && (o.set(m.id, m.uploadCache.content, m.uploadCache.config, m.uploadCache.tags, m.uploadCache.append), m.hasInitData && (m.initPreview(), m.initPreviewDeletes())), m.unlock(), m.clearFileInput(), m.raise("filebatchuploadcomplete", [m.filestack, m.getExtraData()]), m.uploadCount = 0, m.uploadStatus = {}, m.uploadLog = [], m.setProgress(100)
                }, 100)
            }, c = function (t) {
                r = m.getOutData(t), m.fileBatchCompleted = !1, m.showPreview && (n.hasClass("file-preview-success") || (m.setThumbStatus(n, "Loading"), u(n, "file-uploading")), s.attr("disabled", !0), d.attr("disabled", !0)), a || m.lock(), m.raise("filepreupload", [r, b, i]), e.extend(!0, x, r), m.abort(x) && (t.abort(), m.setProgressCancelled())
            }, p = function (t, l, o) {
                r = m.getOutData(o, t), e.extend(!0, x, r), setTimeout(function () {
                    V(t) || V(t.error) ? (m.showPreview && (m.setThumbStatus(n, "Success"), s.hide(), m.initUploadSuccess(t, n, a)), m.raise("fileuploaded", [r, b, i]), a ? g(i, b) : m.updateStack(i, void 0)) : (m.showUploadError(t.error, x), m.setPreviewError(n, i), a && g(i, b))
                }, 100)
            }, f = function () {
                setTimeout(function () {
                    m.showPreview && (s.removeAttr("disabled"), d.removeAttr("disabled"), n.removeClass("file-uploading")), a ? l() : (m.unlock(!1), m.clearFileInput()), m.initSuccessThumbs()
                }, 100)
            }, v = function (r, l, o) {
                var s = m.parseError(r, o, a ? t[i].name : null);
                setTimeout(function () {
                    a && g(i, b), m.uploadStatus[b] = 100, m.setPreviewError(n, i), e.extend(!0, x, m.getOutData(r)), m.showUploadError(s, x)
                }, 100)
            }, w.append(m.uploadFileAttr, t[i], m.filenames[i]), w.append("file_id", i), m.ajaxSubmit(c, p, f, v, b, i))
        }, uploadBatch: function () {
            var i, t, a, r, n, l = this, o = l.filestack, s = o.length, d = {}, c = l.filestack.length > 0 || !e.isEmptyObject(l.uploadExtraData);
            l.formdata = new FormData, 0 !== s && c && !l.abort(d) && (n = function () {
                e.each(o, function (e) {
                ...
                l.showPreview && l.getThumbs().each(function () {
                    ...
                    i.hasClass("file-preview-success") || (l.setThumbStatus(i, "Loading"), u(i, "file-uploading")), t.attr("disabled", !0), a.attr("disabled", !0)
                }), l.raise("filebatchpreupload", [t]), l.abort(t) && (i.abort(), l.setProgressCancelled())
            }, t = function (i, t, a) {
                var r = l.getOutData(a, i), o = l.getThumbs(), s = 0, d = V(i) || V(i.errorkeys) ? [] : i.errorkeys;
                V(i) || V(i.error) ? (l.raise("filebatchuploadsuccess", [r]), n(), l.showPreview ? (o.each(function () {
                ...
                }), l.initUploadSuccess(i)) : l.reset()) : (l.showPreview && (o.each(function () {
                    var i = e(this), t = i.find(".kv-file-remove"), a = i.find(".kv-file-upload");
                    return i.removeClass("file-uploading"), a.removeAttr("disabled"), t.removeAttr("disabled"), 0 === d.length ? void l.setPreviewError(i) : (-1 !== e.inArray(s, d) ? l.setPreviewError(i) : (i.find(".kv-file-upload").hide(), l.setThumbStatus(i, "Success"), l.updateStack(s, void 0)), void s++)
                }), l.initUploadSuccess(i)), l.showUploadError(i.error, r, "filebatchuploaderror"))
            }, r = function () {
                ...
                l.showUploadError(n, r, "filebatchuploaderror"), l.uploadFileCount = s - 1, l.showPreview && (l.getThumbs().each(function () {
                    ...
                    i.removeClass("file-uploading"), void 0 !== l.filestack[t] && l.setPreviewError(i)
                ...
                V(o[e]) || l.formdata.append(l.uploadFileAttr, i, l.filenames[e])
            }), l.ajaxSubmit(i, t, r, a))
        }, uploadExtraOnly: function () {
            var e, i, t, a, r = this, n = {};
            r.formdata = new FormData, r.abort(n) || (e = function (e) {
                r.lock();
                var i = r.getOutData(e);
                r.raise("filebatchpreupload", [i]), r.setProgress(50), n.data = i, n.xhr = e, r.abort(n) && (e.abort(), r.setProgressCancelled())
            }, i = function (e, i, t) {
                var a = r.getOutData(t, e);
                V(e) || V(e.error) ? (r.raise("filebatchuploadsuccess", [a]), r.clearFileInput(), r.initUploadSuccess(e)) : r.showUploadError(e.error, a, "filebatchuploaderror")
            }, t = function () {
            ...
            i.showPreview && (i.$preview.find(".kv-file-remove").each(function () {
                ...
                l(s, "click", function () {
                    return n = i.raise("filepreremove", [c, p]), n !== !1 && i.validateMinCount() ? (t = d.hasClass("file-preview-error"), i.cleanMemory(d), void d.fadeOut("slow", function () {
                        ...
                        i.clearFileInput(), 0 !== l || 0 !== s || u ? (a = s + l, r = a > 1 ? i.getMsgSelected(a) : n[0] ? i.getFileNames()[0] : "", i.setCaption(r)) : i.reset(), i.raise("fileremoved", [c, p])
                    })) : !1
                })
            ...
            e && (i = t.msgFoldersNotAllowed.replace(/\{n}/g, e), t.addError(i), u(t.$container, "has-error"), a.fadeIn(800), t.raise("filefoldererror", [e, i]))
            ...
            return 0 === r.find("ul").length ? a.addError("<ul>" + l + "</ul>") : r.find("ul").append(l), r.fadeIn(800), a.raise(n, [i, e]), a.$container.removeClass("file-input-new"), u(a.$container, "has-error"), !0
        }, showError: function (e, i, t) {
            var a = this, r = a.$errorContainer, n = t || "fileerror";
            return i = i || {}, i.reader = a.reader, a.addError(e), r.fadeIn(800), a.raise(n, [i, e]), a.isUploadable || a.clearFileInput(), a.$container.removeClass("file-input-new"), u(a.$container, "has-error"), a.$btnUpload.attr("disabled", !0), !0
            ...
            i.addError(a), i.isError = !0, i.updateFileDetails(0), r.fadeIn(800), i.raise("fileerror", [e, a]), i.clearFileInput(), u(i.$container, "has-error")
            ...
            var i, t, a, r, n = this;
            for (r = 0; r < W.length; r += 1)if (a = W[r], i = X(a, n.fileTypeSettings) ? n.fileTypeSettings[a] : _[a], t = i(e.type, e.name) ? a : "", !V(t))return t;
            return "other"
        }, previewDefault: function (i, a, r) {
            if (this.showPreview) {
                var n = this, l = "", o = i ? i.name : "", s = t.createObjectURL(i), d = a.slice(a.lastIndexOf("-") + 1), c = n.previewSettings.other || q.other, p = n.renderFileFooter(i.name, c.width), u = n.parseFilePreviewIcon(n.getPreviewTemplate("other"), o);
                r === !0 && (n.isUploadable || (p += '<div class="file-other-error" title="' + n.fileActionSettings.indicatorErrorTitle + '">' + n.fileActionSettings.indicatorError + "</div>")), n.clearDefaultPreview(), n.$preview.append("\n" + u.replace(/\{previewId}/g, a).replace(/\{frameClass}/g, l).replace(/\{fileindex}/g, d).replace(/\{caption}/g, n.slug(i.name)).replace(/\{width}/g, c.width).replace(/\{height}/g, c.height).replace(/\{type}/g, i.type).replace(/\{data}/g, s).replace(/\{footer}/g, p)), r === !0 && n.isUploadable && n.setThumbStatus(e("#" + a), "Error")
            }
        }, previewFile: function (e, i, t, a, r) {
            if (this.showPreview) {
                var n, l, o, s = this, d = s.parseFileType(i), c = i ? i.name : "", p = s.slug(c), u = s.allowedPreviewTypes, f = s.allowedPreviewMimeTypes, v = s.getPreviewTemplate(d), g = u && u.indexOf(d) >= 0, m = X(d, s.previewSettings) ? s.previewSettings[d] : q[d], h = f && -1 !== f.indexOf(i.type), w = s.renderFileFooter(p, m.width), b = "", C = a.slice(a.lastIndexOf("-") + 1);
                g || h ? (v = s.parseFilePreviewIcon(v, c.split(".").pop()), "text" === d ? (l = Y(t.target.result), o = "text-" + Q(), n = v.replace(/\{zoom}/g, s.getLayoutTemplate("zoom")), b = s.getLayoutTemplate("modal").replace("{id}", o).replace(/\{title}/g, p).replace(/\{body}/g, l).replace(/\{heading}/g, s.msgZoomModalHeading), n = n.replace(/\{previewId}/g, a).replace(/\{caption}/g, p).replace(/\{width}/g, m.width).replace(/\{height}/g, m.height).replace(/\{frameClass}/g, "").replace(/\{zoomInd}/g, s.zoomIndicator).replace(/\{footer}/g, w).replace(/\{fileindex}/g, C).replace(/\{type}/g, i.type).replace(/\{zoomTitle}/g, s.msgZoomTitle).replace(/\{dialog}/g, "$('#" + o + "').modal('show')").replace(/\{data}/g, l) + b) : n = v.replace(/\{previewId}/g, a).replace(/\{caption}/g, p).replace(/\{frameClass}/g, "").replace(/\{type}/g, i.type).replace(/\{fileindex}/g, C).replace(/\{width}/g, m.width).replace(/\{height}/g, m.height).replace(/\{footer}/g, w).replace(/\{data}/g, r), s.clearDefaultPreview(), s.$preview.append("\n" + n), s.validateImage(e, a, p, i.type)) : s.previewDefault(i, a)
            }
        }, slugDefault: function (e) {
            return V(e) ? "" : String(e).replace(/[\-\[\]\/\{}:;#%=\(\)\*\+\?\\\^\$\|<>&"']/g, "_")
            ...
            var r, n = this, l = n.$element, o = n.$preview, s = n.reader, d = n.$previewContainer, c = n.$previewStatus, p = n.msgLoading, u = n.msgProgress, f = n.previewInitId, v = i.length, g = n.fileTypeSettings, m = n.filestack.length, h = function (t, a, l, o) {
                var s = e.extend(!0, {}, n.getOutData({}, {}, i), {id: l, index: o}), d = {
                    id: l,
                    index: o,
                    file: a,
                    files: i
                };
                return n.previewDefault(a, l, !0), n.isUploadable && n.addToStack(void 0), setTimeout(r(o + 1), 100), n.initFileActions(), n.removeFromPreviewOnError && e("#" + l).remove(), n.isUploadable ? n.showUploadError(t, s) : n.showError(t, d)
            };
            n.loadedImages = [], n.totalImagesCount = 0, e.each(i, function (e, i) {
                var t = n.fileTypeSettings.image || _.image;
                t && t(i.type) && n.totalImagesCount++
            }), r = function (e) {
                if (V(l.attr("multiple")) && (v = 1), e >= v)return n.isUploadable && n.filestack.length > 0 ? n.raise("filebatchselected", [n.getFileStack()]) : n.raise("filebatchselected", [i]), d.removeClass("file-thumb-loading"), void c.html("");
                var w, b, C, x, y, T, F = m + e, E = f + "-" + F, I = i[e], $ = n.slug(I.name), k = (I.size || 0) / 1e3, P = "", S = t.createObjectURL(I), D = 0, U = n.allowedFileTypes, A = V(U) ? "" : U.join(", "), j = n.allowedFileExtensions, L = V(j) ? "" : j.join(", ");
                if (V(j) || (P = new RegExp("\\.(" + j.join("|") + ")$", "i")), k = k.toFixed(2), n.maxFileSize > 0 && k > n.maxFileSize)return x = n.msgSizeTooLarge.replace("{name}", $).replace("{size}", k).replace("{maxSize}", n.maxFileSize), void(n.isError = h(x, I, E, e));
                if (!V(U) && K(U)) {
                    for (C = 0; C < U.length; C += 1)y = U[C], b = g[y], T = void 0 !== b && b(I.type, $), D += V(T) ? 0 : T.length;
                    if (0 === D)return x = n.msgInvalidFileType.replace("{name}", $).replace("{types}", A), void(n.isError = h(x, I, E, e))
                }
                return 0 !== D || V(j) || !K(j) || V(P) || (T = a($, P), D += V(T) ? 0 : T.length, 0 !== D) ? n.showPreview ? (o.length > 0 && void 0 !== FileReader ? (c.html(p.replace("{index}", e + 1).replace("{files}", v)), d.addClass("file-thumb-loading"), s.onerror = function (e) {
                    n.errorHandler(e, $)
                }, s.onload = function (i) {
                    n.previewFile(e, I, i, E, S), n.initFileActions()
                }, s.onloadend = function () {
                    x = u.replace("{index}", e + 1).replace("{files}", v).replace("{percent}", 50).replace("{name}", $), setTimeout(function () {
                        c.html(x), n.updateFileDetails(v), r(e + 1)
                    }, 100), n.raise("fileloaded", [I, E, e, s])
                }, s.onprogress = function (i) {
                    if (i.lengthComputable) {
                        var t = i.loaded / i.total * 100, a = Math.ceil(t);
                        x = u.replace("{index}", e + 1).replace("{files}", v).replace("{percent}", a).replace("{name}", $), setTimeout(function () {
                            c.html(x)
                        }, 100)
                    }
                }, w = X("text", g) ? g.text : _.text, w(I.type, $) ? s.readAsText(I, n.textEncoding) : s.readAsArrayBuffer(I)) : (n.previewDefault(I, E), setTimeout(function () {
                    r(e + 1), n.updateFileDetails(v)
                }, 100), n.raise("fileloaded", [I, E, e, s])), void n.addToStack(I)) : (n.addToStack(I), setTimeout(r(e + 1), 100), void n.raise("fileloaded", [I, E, e, s])) : (x = n.msgInvalidFileExtension.replace("{name}", $).replace("{extensions}", L), void(n.isError = h(x, I, E, e)))
            }, r(0), n.updateFileDetails(v, !1)
        }, updateFileDetails: function (e) {
            var i = this, t = i.$element, a = i.getFileStack(), r = t[0].files[0] && t[0].files[0].name || a.length && a[0].name || "", n = i.slug(r), l = i.isUploadable ? a.length : e, s = o.count(i.id) + l, d = l > 1 ? i.getMsgSelected(s) : n;
            i.isError ? (i.$previewContainer.removeClass("file-thumb-loading"), i.$previewStatus.html(""), i.$captionContainer.find(".kv-caption-icon").hide()) : i.showFileIcon(), i.setCaption(d, i.isError), i.$container.removeClass("file-input-new file-input-ajax-new"), 1 === arguments.length && i.raise("fileselect", [e, n]), o.count(i.id) && i.initPreviewDeletes()
            ...
            var t = this, a = t.$element;
            if (!t.isUploadable && V(a.val()) && t.fileInputCleared)return void(t.fileInputCleared = !1);
            t.fileInputCleared = !1;
            var r, n, l, s, d, c, p = arguments.length > 1, u = t.isUploadable, f = 0, v = p ? i.originalEvent.dataTransfer.files : a.get(0).files, g = t.filestack.length, m = V(a.attr("multiple")), h = m && g > 0, w = 0, b = function (i, a, r, n) {
                var l = e.extend(!0, {}, t.getOutData({}, {}, v), {id: r, index: n}), o = {
                    id: r,
                    index: n,
                    file: a,
                    files: v
            ...
            if (t.reader = null, t.resetUpload(), t.hideFileIcon(), t.isUploadable && t.$container.find(".file-drop-zone ." + t.dropZoneTitleClass).remove(), p)for (r = []; v[f];)s = v[f], s.type || s.size % 4096 !== 0 ? r.push(s) : w++, f++; else r = void 0 === i.target.files ? i.target && i.target.value ? [{name: i.target.value.replace(/^.+\\/, "")}] : [] : i.target.files;
            if (V(r) || 0 === r.length)return u || t.clear(), t.showFolderError(w), void t.raise("fileselectnone");
            if (t.resetErrors(), c = r.length, l = t.getFileCount(t.isUploadable ? t.getFileStack().length + c : c), t.maxFileCount > 0 && l > t.maxFileCount) {
                if (!t.autoReplace || c > t.maxFileCount)return d = t.autoReplace && c > t.maxFileCount ? c : l, n = t.msgFilesTooMany.replace("{m}", t.maxFileCount).replace("{n}", d), t.isError = b(n, null, null, null), t.$captionContainer.find(".kv-caption-icon").hide(), t.setCaption("", !0), void t.$container.removeClass("file-input-new file-input-ajax-new");
                l > t.maxFileCount && t.resetPreviewThumbs(u)
            } else!u || h ? (t.resetPreviewThumbs(!1), h && t.clearStack()) : !u || 0 !== g || o.count(t.id) && !t.overwriteInitial || t.resetPreviewThumbs(!0);
            t.isPreviewable ? t.readFiles(r) : t.updateFileDetails(1), t.showFolderError(w)
        ...
        }, setPreviewError: function (e, i, t) {
            var a = this;
            i && a.updateStack(i, t), a.removeFromPreviewOnError ? e.remove() : a.setThumbStatus(e, "Error")
        }, checkDimensions: function (e, i, t, a, r, n, l) {
            var o, s, d, c, p = this, u = "Small" === i ? "min" : "max", f = p[u + "Image" + n];
            !V(f) && t.length && (d = t[0], s = "Width" === n ? d.naturalWidth || d.width : d.naturalHeight || d.height, c = "Small" === i ? s >= f : f >= s, c || (o = p["msgImage" + n + i].replace("{name}", r).replace("{size}", f), p.showUploadError(o, l), p.setPreviewError(a, e, null)))
        }, validateImage: function (e, i, a, r) {
            var n, o, s, d = this, c = d.$preview, p = c.find("#" + i), u = p.find("img");
            a = a || "Untitled", u.length && l(u, "load", function () {
                o = p.width(), s = c.width(), o > s && (u.css("width", "100%"), p.css("width", "97%")), n = {
                    ind: e,
                    id: i
                }, d.checkDimensions(e, "Small", u, p, a, "Width", n), d.checkDimensions(e, "Small", u, p, a, "Height", n), d.resizeImage || (d.checkDimensions(e, "Large", u, p, a, "Width", n), d.checkDimensions(e, "Large", u, p, a, "Height", n)), d.raise("fileimageloaded", [i]), d.loadedImages.push({
                    ind: e,
                    img: u,
                    thumb: p,
                    pid: i,
                    typ: r
                }), d.validateAllImages(), t.revokeObjectURL(u.attr("src"))
            })
            ...
            if (o.loadedImages.length === o.totalImagesCount && (o.raise("fileimagesloaded"), o.resizeImage)) {
                for (l = o.isUploadable ? o.showUploadError : o.showError, e = 0; e < o.loadedImages.length; e++)i = o.loadedImages[e], t = i.img, a = i.thumb, r = i.pid, n = i.ind, s = {
                    id: r,
                    index: n
                }, o.getResizedImage(t[0], i.typ, r, n) || (l(o.msgImageResizeError, s, "fileimageresizeerror"), o.setPreviewError(a, n));
            ...
            return e.overwriteInitial || V(i) ? (e.$caption.html(""), !1) : (e.setCaption(i), !0)
        }, setCaption: function (i, t) {
            var a, r, n, l, o = this, s = o.getFileStack();
            if (o.$caption.length) {
                if (t)a = e("<div>" + o.msgValidationError + "</div>").text(), n = s.length, l = n ? 1 === n && s[0] ? o.getFileNames()[0] : o.getMsgSelected(n) : o.getMsgSelected(o.msgNo), r = '<span class="' + o.msgValidationErrorClass + '">' + o.msgValidationErrorIcon + (V(i) ? l : i) + "</span>"; else {
                    if (V(i))return;
                    a = e("<div>" + i + "</div>").text(), r = o.getLayoutTemplate("icon") + a
                }
            ...
            var i = this, t = e(document.createElement("div")).attr({"class": "file-input file-input-new"}).html(i.renderMain());
            ...
            var i = this, t = i.getLayoutTemplate("btnDefault"), a = i[e + "Class"], r = i[e + "Title"], n = i[e + "Icon"], l = i[e + "Label"], o = i.isDisabled ? " disabled" : "", s = "button";
            switch (e) {
                case"remove":
            ...
            return a += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button", V(l) || (l = ' <span class="' + i.buttonLabelClass + '">' + l + "</span>"), t.replace("{type}", s).replace("{css}", a).replace("{title}", r).replace("{status}", o).replace("{icon}", n).replace("{label}", l)
        }
        ...
        if (d() || r(9)) {
            ...
            switch (t.shift(), this.each(function () {
                ...
                l || ("en" === s || V(e.fn.fileinputLocales[s]) || (d = e.fn.fileinputLocales[s]), r = e.extend(!0, {}, e.fn.fileinput.defaults, e.fn.fileinputLocales.en, d, o, n.data()), l = new ee(this, r), n.data("fileinput", l)), "string" == typeof i && a.push(l[i].apply(l, t))
            }), a.length) {
                case 0:
                    return this;
                case 1:
    ...
    }, e.fn.fileinput.Constructor = ee, e(document).ready(function () {
